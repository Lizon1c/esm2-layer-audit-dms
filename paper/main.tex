...
\author{Author One$^{1,\ast}$ \and Author Two$^{1}$\\
\small $^{1}$Affiliation placeholder\\
\small $^{\ast}$Corresponding author: \texttt{email@placeholder}}
\date{}
...
mapped to its source file in the accompanying \texttt{TRACEABILITY.md}.
